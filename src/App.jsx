      ...
      <main className="relative z-10 max-w-7xl mx-auto px-6 pt-32 pb-20">
        ...
        <div className={`mb-24 transition-all duration-1000 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-col font-syne font-extrabold text-4xl md:text-7xl uppercase leading-tight tracking-tighter">
              ...
              <div className="flex flex-wrap gap-x-4 gap-y-1 md:gap-6 text-2xl md:text-4xl mt-4 text-gray-400 font-bold">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-3 gap-4 min-h-[800px]">
          ...
          >
            <img 
              src="/../public/shaamkichaicover.jpg" 
